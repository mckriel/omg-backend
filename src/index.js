...
import statsJewelryGemsRouter from './routes/statsJewelryGems.js';
...
app.use('/stats/jewelry-gems', statsJewelryGemsRouter);
...
server.listen(port, host, async () => {
    ...
    try {
        ...
        console.error('❌ Failed to initialize mongoose connection:', error);
    }
});
